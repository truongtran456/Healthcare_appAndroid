...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1 = findViewById(R.id.editTextTBFullName);
        ed2 = findViewById(R.id.editTextTBAddress);
        ed3 = findViewById(R.id.editTextTBPincode);
        ed4 = findViewById(R.id.editTextTBContact);
        dateButton = findViewById(R.id.buttonCartAppDate);
        timeButton = findViewById(R.id.buttonCartTime);
        btnBook = findViewById(R.id.buttonTBBooking);
