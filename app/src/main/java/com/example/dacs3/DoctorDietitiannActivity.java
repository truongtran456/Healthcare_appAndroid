...
public class DoctorDietitiannActivity extends AppCompatActivity {

    private String[][] doctor_detail1=
            {
                    {"Doctor name: Ajiti Saste", "Hospital Address: Pimpri", "EXP:5year", "Mobile No: 0994222939", "50"},
                    {"Doctor name: Xenia Tryphena", "Hospital Address: Hue", "EXP:2year", "Mobile No: 0994222939", "30"},
                    {"Doctor name: Acacia", "Hospital Address: Ho Chi Minh", "EXP:1year", "Mobile No: 0994222939", "20"},
                    {"Doctor name: Veronica Verity", "Hospital Address: Ha Noi", "EXP:3year", "Mobile No: 0994222939", "60"},
                    {"Doctor name: Verity Ula", "Hospital Address: Da Nang", "EXP:5year", "Mobile No: 0994222939", "100"},
                    {"Doctor name: Tryphena Winifred", "Hospital Address: Ha Long", "EXP:8year", "Mobile No: 0994222939", "70"},
                    {"Doctor name: Verity Xenia", "Hospital Address: Quang Tri", "EXP:9year", "Mobile No: 0994222939", "25"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_dietitiann);
        ...
        DTDeatailsback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DoctorDietitiannActivity.this, FindDoctorActivity.class));
            }
        });
        list = new ArrayList();
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(DoctorDietitiannActivity.this, BookAppointmentActivity.class);
