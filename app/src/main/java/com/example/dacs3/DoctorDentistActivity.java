...
public class DoctorDentistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DTDeatailsback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DoctorDentistActivity.this, FindDoctorActivity.class));
            }
        });
        list = new ArrayList();
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(DoctorDentistActivity.this, BookAppointmentActivity.class);
