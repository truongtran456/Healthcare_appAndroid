...
public class DoctorSurgenonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_surgenon);
        ...
        DTDeatailsback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DoctorSurgenonActivity.this, FindDoctorActivity.class));
            }
        });
        list = new ArrayList();
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(DoctorSurgenonActivity.this, BookAppointmentActivity.class);
